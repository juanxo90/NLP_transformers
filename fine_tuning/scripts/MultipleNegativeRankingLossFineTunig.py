...
### Multiple Negative Ranking Loss for retail data, this is an 
...
# Training for multiple epochs can be beneficial, 
# as in each epoch a mini-batch is sampled differently
...
# Choose it as large as possible batch size of 300-350 (requires about 30 GB of GPU memory)
train_batch_size = 64
...
model_save_path = os.path.join(os.path.dirname(os.path.dirname(os.getcwd())), 
                               'data/output/training_retailMultiNegativeRankingLoss-')\
